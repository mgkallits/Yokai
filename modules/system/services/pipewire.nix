...

{
  ...
  #         args = {
  #           node.description = "Spotify Resampler";
  #           capture.props = {
  #             media.class = "Audio/Source";
  #             target.object = "alsa_playback.spotify_player"; # Match Spotify Player's output
  #           };
  #           playback.props = {
  #             media.class = "Audio/Sink";
  #             audio.position = [ "FL" "FR" ];
  #             node.name = "spotify_resampled";
  #             node.target = "alsa_output.pci-0000_0c_00.4.analog-stereo"; # Replace with your output device
  #           };
  #           stream.props = {
  #             resample.quality = 15; # Highest resampling quality
  #             audio.rate = 96000;   # Resample to 96 kHz
  #           };
  #         };
  #       }
  #     ];
