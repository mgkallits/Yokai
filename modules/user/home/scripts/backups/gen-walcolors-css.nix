...
let
  ...
  scriptContent = ''
    ...
    OUTPUT_PATH="$HOME/.cache/wal/colors.css"
    ...
    cat << EOF > "$OUTPUT_PATH"
    /* CSS variables
      Generated by 'colors-vscode.sh' */
    :root {
        --wallpaper: url("/home/mgkallits/Pictures/waves-minimal-4k-ay-2560x1440.jpg");
...
in {
  home.file.".local/bin/wal-colors-css.sh" = {
    text = scriptContent;
    executable = true;
  };
}
